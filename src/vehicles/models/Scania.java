...
import vehicles.AdjustablePlatform;
import vehicles.BaseVehicle;
import vehicles.VehicleVisitor;

import java.awt.*;

/**
 * A vehicles.models.Scania truck.
 *
 * <pre>
 *                                      /`-.
                                 \   `-._
...
public class Scania extends BaseVehicle {
    ...
    /**
     * The truck bed of vehicles.models.Scania trucks.
     *
     * Can be tilted.
     */
    public static final class ScaniaTruckBed implements AdjustablePlatform {
        ...
        /** Constructs a new vehicles.models.Scania truck bed at the specified angle.
         *
        ...
        /**
         * Constructs a new vehicles.models.Scania truck bed in resting position.
         */
